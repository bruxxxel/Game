...
void draw_menu_boxes (int width, int height) {
	...
	al_draw_rectangle(2*width/10-10,5*height/10,5*width/10-10,6*height/10,al_map_rgb(255,0,255),1);	//	Play
	al_draw_rectangle(8*width/10+10,5*height/10,5*width/10+10,6*height/10,al_map_rgb(255,0,255),1);	//	Change Character

	//	Caixas das opções inferiores
	al_draw_rectangle(2*width/10-10,(7*height/10)-height/20,5*width/10-10,(8*height/10)-height/20,al_map_rgb(255,0,255),1);	//	Replay Introduction
	al_draw_rectangle(8*width/10+10,(7*height/10)-height/20,5*width/10+10,(8*height/10)-height/20,al_map_rgb(255,0,255),1);	//	Close

	//	Caixa das informações do jogo
	al_draw_rectangle(5,height-5,width/2,height-20,al_map_rgb(255,0,255),1);

	//	Caixa da seleção SFX, Music e Screen Resolution
	al_draw_rectangle(width-5,5,width-45,45,al_map_rgb(255,0,255),1);		//	Screen Resolution
	al_draw_rectangle(width-50,5,width-90,45,al_map_rgb(255,0,255),1);	//	Sound
}
...
void draw_menu_text (int width, int height, ALLEGRO_FONT *menufont, ALLEGRO_FONT *titlefont) {
	...
	//	Opção 2
	al_draw_text(menufont,al_map_rgb(255,255,255),2*width/3+width/30,5*height/10+height/35,ALLEGRO_ALIGN_CENTER,"Change Character");
	//	Opção 3
